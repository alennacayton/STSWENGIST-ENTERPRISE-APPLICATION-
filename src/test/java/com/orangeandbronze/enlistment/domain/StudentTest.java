...
class StudentTest {
    ...
    void enlist_two_sections_no_conflict() {
        ...
        Section sec1 = new Section("A", new Subject("C"), MTH830to10, new Room("X", 10), DEFAULT_FACULTY);
        Section sec2 = new Section("B", new Subject("D"), TF10to1130, new Room("Y", 10),DEFAULT_FACULTY);
    ...
    void enlist_two_sections_same_schedule() {
        ...
        Student student = newDefaultStudent();
        Section sec1 = new Section("A", new Subject("C"), MTH830to10, new Room("X", 10) , DEFAULT_FACULTY);
        Section sec2 = new Section("B", new Subject("D"), MTH830to10, new Room("Y", 10) , DEFAULT_FACULTY);
        // When the student enlists in both sections
        student.enlist(sec1);
    ...
    void enlist_students_at_capacity_in_two_sections_sharing_the_same_room() {
        ...
        final int CAPACITY = 1;
        Room room = new Room("X", CAPACITY);
        Section sec1 = new Section("A", new Subject("C"), MTH830to10, room, DEFAULT_FACULTY);
        Section sec2 = new Section("B", new Subject("C"), TF830to10, room, DEFAULT_FACULTY);
        Student student1 = newStudent(1);
        Student student2 = newStudent(2);
    ...
    void cancel_enlisted_section() {
        ...
        Section sec1 = new Section("A", new Subject("D"), MTH830to10, new Room("X", 10), DEFAULT_FACULTY, INITIAL_NUMBER_OF_STUDENTS);
        Section sec2 = new Section("B", new Subject("E"), TF830to10, new Room("Y", 10), DEFAULT_FACULTY, INITIAL_NUMBER_OF_STUDENTS);
        Section sectionToBeCanceled = new Section("C", new Subject("F"), new Schedule(WS, H0830), new Room("Z", 10), DEFAULT_FACULTY, INITIAL_NUMBER_OF_STUDENTS);
    ...
    void enlist_two_sections_same_subject() {
        ...
        Student student = newDefaultStudent();
        Section sec1 = new Section("A", new Subject("C"), MTH830to10, new Room("X", 10), DEFAULT_FACULTY);
        Section sec2 = new Section("B", new Subject("C"), TF830to10, new Room("Y", 10), DEFAULT_FACULTY);

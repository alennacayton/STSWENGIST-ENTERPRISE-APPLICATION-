...
-- changeset alenn:1644219817019-1
CREATE TABLE "public"."section" ("section_id" TEXT NOT NULL, "number_of_students" INTEGER NOT NULL, "days" INTEGER, "end_time" TIME WITHOUT TIME ZONE, "start_time" TIME WITHOUT TIME ZONE, "version" INTEGER DEFAULT 0 NOT NULL, "instructor_faculty_number" INTEGER, "room_name" TEXT, "subject_subject_id" TEXT, CONSTRAINT "section_pkey" PRIMARY KEY ("section_id"));

-- changeset alenn:1644219817019-2
CREATE TABLE "public"."room_sections" ("room_name" TEXT NOT NULL, "sections_section_id" TEXT NOT NULL);

-- changeset alenn:1644219817019-3
CREATE TABLE "public"."subject" ("subject_id" TEXT NOT NULL, CONSTRAINT "subject_pkey" PRIMARY KEY ("subject_id"));

-- changeset alenn:1644219817019-4
CREATE TABLE "public"."subject_prerequisites" ("subject_subject_id" TEXT NOT NULL, "prerequisites_subject_id" TEXT NOT NULL);

-- changeset alenn:1644219817019-5
CREATE TABLE "public"."student_sections" ("student_student_number" INTEGER NOT NULL, "sections_section_id" TEXT NOT NULL);

-- changeset alenn:1644219817019-6
CREATE TABLE "public"."room" ("name" TEXT NOT NULL, "capacity" INTEGER NOT NULL, CONSTRAINT "room_pkey" PRIMARY KEY ("name"));

-- changeset alenn:1644219817019-7
...
-- changeset alenn:1644219817019-8
CREATE TABLE "public"."faculty" ("faculty_number" INTEGER NOT NULL, "firstname" VARCHAR, "lastname" VARCHAR, CONSTRAINT "faculty_pkey" PRIMARY KEY ("faculty_number"));

-- changeset alenn:1644219817019-9
...
-- changeset alenn:1644219817019-10
...
-- changeset alenn:1644219817019-11
...
-- changeset alenn:1644219817019-12
...
-- changeset alenn:1644219817019-13
ALTER TABLE "public"."section" ADD CONSTRAINT "fkhbrcxeiyot9gwvpjd9klgc0rw" FOREIGN KEY ("instructor_faculty_number") REFERENCES "public"."faculty" ("faculty_number") ON UPDATE NO ACTION ON DELETE NO ACTION;

-- changeset alenn:1644219817019-14
...
-- changeset alenn:1644219817019-15
...
-- changeset alenn:1644219817019-18
...
-- changeset alenn:1644219817019-19
...
-- changeset alenn:1644219817019-20
...
-- changeset alenn:1644219817019-21
...
-- changeset alenn:1644219817019-22
--validCheckSum: any
